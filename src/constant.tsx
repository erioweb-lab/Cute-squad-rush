...
const cat1 = '/assets/animals/cat/cat1.png';
const cat2 = '/assets/animals/cat/cat2.png';
const cat3 = '/assets/animals/cat/cat3.png';
const cat4 = '/assets/animals/cat/cat4.png';
const cat5 = '/assets/animals/cat/cat5.png';
const dog1 = '/assets/animals/dog/dog1.png';
const dog2 = '/assets/animals/dog/dog2.png';
const dog3 = '/assets/animals/dog/dog3.png';
const dog4 = '/assets/animals/dog/dog4.png';
const dog5 = '/assets/animals/dog/dog5.png';
const rabbit1 = '/assets/animals/rabbit/rabbit1.png';
const rabbit2 = '/assets/animals/rabbit/rabbit2.png';
const rabbit3 = '/assets/animals/rabbit/rabbit3.png';
const rabbit4 = '/assets/animals/rabbit/rabbit4.png';
const rabbit5 = '/assets/animals/rabbit/rabbit5.png';
const rat1 = '/assets/animals/rat/rat1.png';
const rat2 = '/assets/animals/rat/rat2.png';
const rat3 = '/assets/animals/rat/rat3.png';
const rat4 = '/assets/animals/rat/rat4.png';
const rat5 = '/assets/animals/rat/rat5.png';
const iceImg = '/assets/enemies/ice.png';
const fireImg = '/assets/enemies/fire.png';
const slimeImg = '/assets/enemies/slime.png';
const poisonImg = '/assets/enemies/poison.png';
const bombImg = '/assets/enemies/bomb.png';
const fireBulletImg = '/assets/bullets/fire_bullet.png';
const iceBulletImg = '/assets/bullets/ice_bullet.png';
const poisonBulletImg = '/assets/bullets/poison_bullet.png';
const electricBulletImg = '/assets/bullets/electric_bullet.png';
const laserBulletImg = '/assets/bullets/laser_bullet.png';
const bossFireBulletImg = '/assets/boss_bullets/fire_bullet.png';
const bossIceBulletImg = '/assets/boss_bullets/ice_bullet.png';
const bossPoisonBulletImg = '/assets/boss_bullets/poison_bullet.png';
const bossElectricBulletImg = '/assets/boss_bullets/electric_bullet.png';
const bossLaserBulletImg = '/assets/boss_bullets/laser_bullet.png';
const coinImg = '/assets/items/coin.png';
const blackBombImg = '/assets/items/black_bomb.png';
const feverImg = '/assets/items/fever.png';
const heartImg = '/assets/items/heart.png';
const magnetImg = '/assets/items/magnet.png';
const critImg = '/assets/items/crit.png';
const criticalBulletImg = '/assets/critical-bullet.png';
const shieldImg = '/assets/items/shield.png';
const droneImg = '/assets/items/drone.png';
const droneItemImg = '/assets/items/drone_item.png';
const laserAmmoImg = '/assets/items/laser_ammo.png';
const electricAmmoImg = '/assets/items/electric_ammo.png';
const fireAmmoImg = '/assets/items/fire_ammo.png';
const freezeImg = '/assets/items/freeze.png';
const poisonAmmoImg = '/assets/items/poison_ammo.png';
const homingAmmoImg = '/assets/items/homing_ammo.png';
const iceAmmoImg = '/assets/items/ice_ammo.png';

// Stage Backgrounds
const bg1 = '/assets/background/bg1.png';
const bg2 = '/assets/background/bg2.png';
const bg3 = '/assets/background/bg3.png';
const bg4 = '/assets/background/bg4.png';
const bg5 = '/assets/background/bg5.png';
const bg6 = '/assets/background/bg6.png';
const bg7 = '/assets/background/bg7.png';
const bg8 = '/assets/background/bg8.png';
const bg9 = '/assets/background/bg9.png';
const bg10 = '/assets/background/bg10.png';
const bg11 = '/assets/background/bg11.png';
const bg12 = '/assets/background/bg12.png';
const victoryPose = '/assets/victory_pose.png';

// Boss Images
const acidStalkerImg = '/assets/bosses/acid_stalker.png';
const ancientCoreImg = '/assets/bosses/ancient_core.png';
const beamSentinelImg = '/assets/bosses/beam_sentinel.png';
const iceMonarchImg = '/assets/bosses/ice_monarch.png';
const infernoKingImg = '/assets/bosses/inferno_king.png';
const rockCrackerImg = '/assets/bosses/rock_cracker.png';
const thunderDragonImg = '/assets/bosses/thunder_dragon.png';
const toxicCloudImg = '/assets/bosses/toxic_cloud.png';
const voidEntityImg = '/assets/bosses/void_entity.png';
const voidGlitchImg = '/assets/bosses/void_glitch.png';
const voltSpikerImg = '/assets/bosses/volt_spiker.png';
const vortexBringerImg = '/assets/bosses/vortex_bringer.png';
